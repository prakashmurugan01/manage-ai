...
export default function Dashboard() {
  ...
  if (engine.error) {
    return (
      <EngineCard className="theme-notice-rose">
        <div className="flex items-start gap-3">
          <AlertTriangle className="mt-1 text-[color:var(--danger)]" />
          <div>
              ...
              render={(item) => (
                <div key={item.id} className="rounded-xl border border-[color:var(--border)] bg-[color:var(--surface-soft)] p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {item.status === "down" ? <WifiOff className="theme-text-danger" /> : <Wifi className="theme-text-success" />}
                  </div>
...
function QueryModal({ query, onClose }) {
  return (
    <div className="theme-modal-backdrop fixed inset-0 z-50 grid place-items-center p-4 backdrop-blur-sm">
...
function badgeClass(tone) {
  return {
    emerald: "theme-status-success",
    rose: "theme-status-danger",
    amber: "theme-status-warning",
    cyan: "theme-status-info"
...
function toneBg(tone) {
  ...
  }[tone] || "theme-tone-cyan";
}

function toneText(tone) {
  return {
    emerald: "theme-text-success",
    rose: "theme-text-danger",
    amber: "theme-text-warning",
    cyan: "theme-text-info"
