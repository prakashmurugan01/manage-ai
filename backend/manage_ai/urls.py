...
from apps.ai.views import AssistantSessionViewSet, TaskSuggestionViewSet
from apps.audit.views import APIRequestLogViewSet, AuditLogViewSet
from apps.deployments.views import DeploymentControlViewSet, DeploymentRecordViewSet
...
router.register("deployment-records", DeploymentRecordViewSet, basename="deployment-records")
...
router.register("assistant-sessions", AssistantSessionViewSet, basename="assistant-sessions")
...
urlpatterns = [
    ...
    path("api/", include("apps.project_intelligence.urls")),
