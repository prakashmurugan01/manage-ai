...
from apps.file_tracking.routing import websocket_urlpatterns as file_transfer_websocket_urlpatterns
from apps.project_intelligence.routing import websocket_urlpatterns as project_intelligence_websocket_urlpatterns
...
application = ProtocolTypeRouter(
    {
        ...
        "websocket": JwtAuthMiddlewareStack(
            URLRouter(
                ...
                + uce_websocket_urlpatterns
                + remote_access_websocket_urlpatterns
                + file_transfer_websocket_urlpatterns
                + project_intelligence_websocket_urlpatterns
                + uce_realtime_patterns
            )
        ),
    }
