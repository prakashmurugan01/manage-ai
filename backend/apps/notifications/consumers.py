...
class NotificationConsumer(AsyncJsonWebsocketConsumer):
        ...
        await self.send_json(
            {
                ...
                "unread_count": await self.unread_count(self.user),
            }
        )
    ...
    async def receive_json(self, content, **kwargs):
        ...
        await self.send_json({"type": "notifications_updated", "unread_count": await self.unread_count(user)})
    ...
    def initial_payload(self, user):
        ...
        return {
            ...
            "notifications": NotificationSerializer(qs.order_by("-created_at")[:20], many=True).data,
        }
