...
from .views import ApiIntelligenceDashboardView, ApiKeyUsageLogViewSet, ApiKeyViewSet, ExternalIssueIngestView
...
urlpatterns = [
    path("api-intelligence/dashboard/", ApiIntelligenceDashboardView.as_view(), name="api-intelligence-dashboard"),
