...
from .views import (
    ...
    HostingHealthCheckViewSet,
    HostingIncidentViewSet,
...
router.register("hosting/health-checks", HostingHealthCheckViewSet, basename="hosting-health-checks")
router.register("hosting/incidents", HostingIncidentViewSet, basename="hosting-incidents")
